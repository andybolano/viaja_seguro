...
(function() {
    ...
    function NotificacionesController(notificacionesService, $filter) {
        var vm = this;
        ...
        function guardar(){
            ...
            notificacionesService.post(nActividad).then(success, error);
            function success(p) {
        ...
        function loadAvtividades(){
            vm.actividades = [];
            notificacionesService.getAll().then(success, error);
            function success(p) {
